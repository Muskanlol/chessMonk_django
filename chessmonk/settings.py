...
"""
Django settings for chessmonk project.
...
ROOT_URLCONF = 'chessmonk.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'frontend'/ 'assets'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'chessmonk.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),                 # Expect "Bearer <token>" in headers
}
